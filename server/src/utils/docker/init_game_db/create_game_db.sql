...
-- 탱씨 아저씨 스킬들
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('삽질', 1, 3, 1, 1, 1, NULL);
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('방패막기', 7, 3, NULL, 5, NULL, NULL);
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('궁극기', 5, 3, 0.2, 30, 1, 30);

-- 힐씨 아줌마 스킬들
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('물 뿌리기', 2, 4, 1, 1, NULL, NULL);
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('새참', 5, 4, 1, 5, 10, NULL);
INSERT INTO character_skills (skill_name, skill_type, character_id, damage_factor, cool_time, `range`, `scale`) VALUES ('부활', 6, 4, NULL, 50, 1, NULL);